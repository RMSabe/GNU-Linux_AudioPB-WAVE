...
bool AudioPlayback_24bit2ch::runPlayback(void)
{
	if(this->status < 1)
	{
...
void AudioPlayback_24bit2ch::playback_proc(void)
{
	this->stop = false;
...
void AudioPlayback_24bit2ch::playback_init(void)
{
	this->buffer_remap();
...
void AudioPlayback_24bit2ch::playback_loop(void)
{
	while(!this->stop)
	{
		this->buffer_play();
...
void AudioPlayback_24bit2ch::buffer_remap(void)
{
...
void AudioPlayback_24bit2ch::buffer_play(void)
{
