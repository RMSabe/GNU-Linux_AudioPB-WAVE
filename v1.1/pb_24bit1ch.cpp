...
#define BUFFER_SIZE_SAMPLES 4096U
#define BUFFER_SIZE_BYTES (4U*BUFFER_SIZE_SAMPLES)
#define OUTPUT_BUFFER_SIZE_SAMPLES (2U*BUFFER_SIZE_SAMPLES)
#define OUTPUT_BUFFER_SIZE_BYTES (4U*OUTPUT_BUFFER_SIZE_SAMPLES)
...
void buffer_malloc(void)
{
	...
	if(audio_buffer_size_samples < OUTPUT_BUFFER_SIZE_SAMPLES) buffer_n_div = OUTPUT_BUFFER_SIZE_SAMPLES/audio_buffer_size_samples;
...
void buffer_transfer(void)
{
	...
	while(n_sample < BUFFER_SIZE_SAMPLES)
	{
		...
		load_out[2u*n_sample + 1u] = load_out[2u*n_sample];
